...
const traducciones = {
    "en": {
        ...
        "Suite de herramientas de tramado": "Dithering Tool Suite",
        "Todo funciona en tu navegador — 100% gratuito": "Everything works in your browser — 100% free",
        "Dithering": "Dithering",
        "sin límites": "unlimited",
        "Transforma imágenes en arte retro, crea animaciones con keyframes, o conecta efectos visualmente con el editor por nodos. Tres herramientas, un solo objetivo: llevar el dithering al siguiente nivel.": "Transform photos into retro art, create keyframe animations, or connect effects visually with the node editor. Three tools, one goal: take dithering to the next level.",
        "Editor de Imágenes": "Image Editor",
        "Edición por Nodos": "Node Editor",
        "Animación y Video": "Animation & Video",
        "200+ algoritmos de dithering, control de brillo, contraste, saturación, efectos glitch, post-FX y exportación a PNG/SVG. La herramienta principal.": "200+ dithering algorithms, brightness/contrast/saturation controls, glitch effects, post-FX, and PNG/SVG export. The main tool.",
        "Conecta procesos visualmente: dithering, glitch, blur, mapas de color. Flujo de trabajo modular con cables SVG en tiempo real.": "Connect processes visually: dithering, glitch, blur, color maps. Modular workflow with real-time SVG cables.",
        "Línea de tiempo con keyframes, parámetros animables por frame, exportación a WebM/MP4. Dale movimiento al dithering.": "Keyframe timeline, per-frame animatable parameters, WebM/MP4 export. Give dithering motion.",
        "Abrir Editor": "Open Editor",
        "Abrir Editor de Nodos": "Open Node Editor",
        "Abrir Animación": "Open Animation",
        "100% Privado": "100% Private",
        "Sin Instalación": "No Installation",
        "Alta Calidad": "High Quality",
        "Todo el procesamiento ocurre en tu navegador. Tus imágenes nunca salen de tu dispositivo.": "All processing happens in your browser. Your images never leave your device.",
        "Funciona directamente en el navegador. No requiere descargas, registros ni configuración.": "Works directly in the browser. No downloads, sign-ups, or setup required.",
        "Exportación a PNG, SVG, WebM y MP4 con control total de resolución y paleta de colores.": "Export to PNG, SVG, WebM, and MP4 with full resolution and color palette control.",
        "Editor": "Editor",
        "Nodos": "Nodes",
        "Animación": "Animation",
